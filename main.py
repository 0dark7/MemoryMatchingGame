...
numbers_image = pygame.image.load('images/numbers.png').convert_alpha()
images_image = pygame.image.load('images/images.png').convert_alpha()
carstext_image = pygame.image.load('images/cars.png').convert_alpha()
animalstext_image = pygame.image.load('images/animals.png').convert_alpha()
foodstext_image = pygame.image.load('images/foods.png').convert_alpha()
gmp_image = pygame.image.load('images/gmp.png').convert_alpha()
gmp0_image = pygame.image.load('images/gmp0.png').convert_alpha()
gmp1_image = pygame.image.load('images/gmp1.png').convert_alpha()
...
numbers_button = button.Button(110, 650, numbers_image, 0.28)
images_button = button.Button(240, 650, images_image, 0.314)
carstext_image_button = button.Button(400, 230, carstext_image, 0.5)
animalstext_image_button = button.Button(540, 230, animalstext_image, 0.5)
foodstext_image_button = button.Button(750, 230, foodstext_image, 0.5)
gmp_image_button = button.Button(310, 300, gmp_image, 1)
gmp0_image_button = button.Button(310, 300, gmp0_image, 1)
gmp1_image_button = button.Button(310, 300, gmp1_image, 1)
...
def setttext():
    ...
    if CARD_COUNT == 16:
        if imagemode == 0:
            box1 = pygame.Surface((115, 40), pygame.SRCALPHA)
            box1.fill((0, 0, 0, 128))
            screen.blit(box1, (110, 645))
        if imagemode == 1:
            box1 = pygame.Surface((115, 40), pygame.SRCALPHA)
            box1.fill((0, 0, 0, 128))
            screen.blit(box1, (235, 645))
        if images_button.draw(screen):
            imagemode = 1
            winsound.PlaySound('Click', 1)
            menu_durum = "images"
        if numbers_button.draw(screen):
            imagemode = 0
            winsound.PlaySound('Click', 1)
...
def besttext():
    global player_name
    if CARD_COUNT == 16:
        draw_text("Player       |  Score  |   Time   |  Move  ", font3, TEXT_COL, 300, 235)
...
random.shuffle(image_paths_foods)
image_paths_foods *= 2
...
random.shuffle(image_paths_cars)
image_paths_cars *= 2
...
random.shuffle(image_paths_animals)
image_paths_animals *= 2
    ...
    if imagemode == 1:
        if images == "araba":
            ...
            for i, card in enumerate(cards):
                card.image = pygame.image.load(image_paths_cars[i])
                card.image = pygame.transform.scale(card.image, (CARD_WIDTH, CARD_HEIGHT))
                card.number = i // 2
                card.image_path_cars = image_paths_cars[i]
        ...
        if images == "hayvan":
            ...
            for i, card in enumerate(cards):
                card.image = pygame.image.load(image_paths_animals[i])
                card.image = pygame.transform.scale(card.image, (CARD_WIDTH, CARD_HEIGHT))
                card.number = i // 2
                card.image_path_animals = image_paths_animals[i]
        ...
        if images == "yemek":
            ...
            for i, card in enumerate(cards):
                card.image = pygame.image.load(image_paths_foods[i])
                card.image = pygame.transform.scale(card.image, (CARD_WIDTH, CARD_HEIGHT))
                card.number = i // 2
                card.image_path_foods = image_paths_foods[i]
    ...
    if card_type == "special":
        if card in matched_cards:
            ...
            if card_typee == "ps0":
                ...
                number_text = font.render(str(card.number), True, BLACK)
            if card_typee == "ps1":
                pygame.draw.rect(screen, BLACK, card.rect, border_radius=10)
                pygame.draw.rect(screen, YELLOW, card.rect, width=3, border_radius=10)
                number_text = font.render(str(card.number), True, GRAY1)
            number_rect = number_text.get_rect()
            number_rect.center = card.rect.center
            screen.blit(number_text, number_rect)
        elif card in flipped_cards:
            ...
            if card_typee == "ps0":
                ...
                number_text = font.render(str(card.number), True, BLACK)
            if card_typee == "ps1":
                pygame.draw.rect(screen, (70, 70, 70), card.rect, border_radius=10)
                pygame.draw.rect(screen, BLACK, card.rect, width=3, border_radius=10)
                number_text = font.render(str(card.number), True, BLACK)
            number_rect = number_text.get_rect()
            number_rect.center = card.rect.center
...
while run:
    ...
    if game_menu == True:
        ...
        if menu_durum == "images":

            settingstext_button.draw(screen)
            if back_button.draw(screen):
                winsound.PlaySound('Click', 1)
                menu_durum = "settings"
            if carstext_image_button.draw(screen):
                images = "araba"
                winsound.PlaySound('beep', 1)
            if animalstext_image_button.draw(screen):
                images = "hayvan"
                winsound.PlaySound('zoo', 1)
            if foodstext_image_button.draw(screen):
                images = "yemek"
                winsound.PlaySound('eating', 1)
            if images == "araba":
                draw_text("____", font1, TEXT_COL, 409, 219)
                gmp1_image_button.draw(screen)
            if images == "hayvan":
                draw_text("_______", font1, TEXT_COL, 545, 219)
                gmp0_image_button.draw(screen)

            if images == "yemek":
                draw_text("_____", font1, TEXT_COL, 760, 219)
                gmp_image_button.draw(screen)
                            ...
                            for card in cards:
                                if card.rect.collidepoint(event.pos):
                                    if card not in flipped_cards and card not in matched_cards:
                                        ...
                                        if len(flipped_cards) == 2:
                                            move_counter += 1
                                            if flipped_cards[0].image_path_cars == flipped_cards[1].image_path_cars:
                                                if card_typee == "ps":
                                                    winsound.PlaySound('mor', 1)
                                                if card_typee == "ps0":
                                                    winsound.PlaySound('yesil', 1)
                            ...
                            for card in cards:
                                if card.rect.collidepoint(event.pos):
                                    if card not in flipped_cards and card not in matched_cards:
                                        ...
                                        if len(flipped_cards) == 2:
                                            move_counter += 1
                                            if flipped_cards[0].image_path_foods == flipped_cards[1].image_path_foods:
                                                if card_typee == "ps":
                                                    winsound.PlaySound('mor', 1)
                                                if card_typee == "ps0":
                                                    winsound.PlaySound('yesil', 1)
                            ...
                            for card in cards:
                                if card.rect.collidepoint(event.pos):
                                    if card not in flipped_cards and card not in matched_cards:
                                        ...
                                        if len(flipped_cards) == 2:
                                            move_counter += 1
                                            if flipped_cards[0].image_path_animals == flipped_cards[
                                                1].image_path_animals:
                                                if card_typee == "ps":
                                                    winsound.PlaySound('mor', 1)
                                                if card_typee == "ps0":
                                                    winsound.PlaySound('yesil', 1)
